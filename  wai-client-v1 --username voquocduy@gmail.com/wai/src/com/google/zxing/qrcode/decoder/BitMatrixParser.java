...
final class BitMatrixParser
{
  ...
  {
    int i = paramBitMatrix.getDimension();
    if ((i < 21) || ((i & 0x3) != 1))
    ...
    throws FormatException
  {
    ...
    int i = this.bitMatrix.getDimension();
    ...
    throws FormatException
  {
    ...
    for (int m = 5; m >= 0; m--)
      k = copyBit(8, m, k);
    int n = this.bitMatrix.getDimension();
    int i1 = 0;
    int i2 = n - 8;
    for (int i3 = n - 1; i3 >= i2; i3--)
      i1 = copyBit(i3, 8, i1);
    for (int i4 = n - 7; i4 < n; i4++)
      i1 = copyBit(8, i4, i1);
    ...
    throws FormatException
  {
    ...
    for (int i2 = 5; i2 >= 0; i2--)
      for (int i3 = i - 9; i3 >= m; i3--)
        i1 = copyBit(i2, i3, i1);
    this.parsedVersion = Version.decodeVersionInformation(i1);
    if ((this.parsedVersion != null) && (this.parsedVersion.getDimensionForVersion() == i))
      return this.parsedVersion;
    throw FormatException.getFormatInstance();
  }
