  ...
  implements Parcelable
{
  ...
  public void readFromParcel(Parcel paramParcel)
  {
    ...
    label136: for (this.mStatus = null; ; this.mStatus = Status.valueOf(str))
    {
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    while (true)
    {
      ...
      break;
      label133: paramParcel.writeString(this.mStatus.name());
    }
  }
  ...
  public static enum Status
  {
    static
    {
      ...
      Status[] arrayOfStatus = new Status[12];
 ...
 * Qualified Name:     com.google.android.googleapps.LoginData
